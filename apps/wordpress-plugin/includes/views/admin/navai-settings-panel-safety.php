    ...
    <div class="navai-admin-card navai-guardrails-panel" data-navai-guardrails-panel>
        ...
        <div class="navai-plugin-function-modal navai-guardrail-modal" hidden>
            <div
                ...
                role="dialog"
                aria-modal="true"
                aria-labelledby="navai-guardrail-modal-title"
            >
                <div class="navai-plugin-function-modal-head navai-guardrail-modal-head">
                    <div>
                        <h4
                            id="navai-guardrail-modal-title"
                            class="navai-plugin-function-modal-title navai-guardrail-modal-title"
                            data-label-create="<?php echo esc_attr__('Crear regla', 'navai-voice'); ?>"
                            data-label-edit="<?php echo esc_attr__('Editar regla', 'navai-voice'); ?>"
                        >
                            <?php echo esc_html__('Crear regla', 'navai-voice'); ?>
                        </h4>
                        <p class="navai-admin-description">
                            <?php echo esc_html__('Configura una regla por scope (input/tool/output), tipo (keyword/regex) y accion (block/warn/allow).', 'navai-voice'); ?>
                        </p>
                    </div>
                    <button
                        type="button"
                        class="button button-secondary button-small navai-guardrail-modal-dismiss navai-plugin-function-modal-dismiss--top"
                    >
                ...
                <div class="navai-guardrails-editor" data-navai-guardrails-editor>
                    ...
                    <div class="navai-guardrails-editor-actions">
                        <button
                            type="button"
                            class="button button-primary navai-guardrail-save"
                            data-label-create="<?php echo esc_attr__('Guardar regla', 'navai-voice'); ?>"
                        ...
                        <button type="button" class="button button-secondary navai-guardrail-modal-dismiss">
                            <?php echo esc_html__('Cerrar', 'navai-voice'); ?>
                        </button>
                    </div>
        ...
        <div class="navai-plugin-function-modal navai-guardrail-test-modal" hidden>
            <div
                class="navai-plugin-function-modal-dialog navai-guardrail-test-modal-dialog"
                role="dialog"
                aria-modal="true"
                aria-labelledby="navai-guardrail-test-modal-title"
            >
                <div class="navai-plugin-function-modal-head navai-guardrail-test-modal-head">
                    <div>
                        <h4
                            id="navai-guardrail-test-modal-title"
                            class="navai-plugin-function-modal-title"
                        >
                            <?php echo esc_html__('Probar reglas', 'navai-voice'); ?>
                        </h4>
                        <p class="navai-admin-description">
                            <?php echo esc_html__('Selecciona una regla guardada para precargar scope y pattern, o ejecuta una prueba libre.', 'navai-voice'); ?>
                        </p>
                    </div>
                    <button
                        type="button"
                        class="button button-secondary button-small navai-guardrail-test-modal-dismiss navai-plugin-function-modal-dismiss--top"
                    >
                        <?php echo esc_html__('Cerrar', 'navai-voice'); ?>
                    </button>
                </div>
                ...
                <div class="navai-guardrails-test" data-navai-guardrails-test>
                    <div class="navai-guardrails-grid">
                        <label class="navai-guardrails-grid-span-full">
                            <span><?php echo esc_html__('Regla registrada (opcional)', 'navai-voice'); ?></span>
                            <select class="navai-guardrail-test-rule-select">
                                <option value=""><?php echo esc_html__('Sin regla (prueba libre)', 'navai-voice'); ?></option>
                            </select>
                        </label>
                        <label>
                            <span><?php echo esc_html__('Scope', 'navai-voice'); ?></span>
                    ...
                    <div class="navai-guardrails-editor-actions">
                        <button type="button" class="button button-secondary navai-guardrail-test-clear">
                            <?php echo esc_html__('Limpiar', 'navai-voice'); ?>
                        </button>
                        <button type="button" class="button button-primary navai-guardrail-test-run">
                            <?php echo esc_html__('Probar', 'navai-voice'); ?>
                        </button>
                        <button type="button" class="button button-secondary navai-guardrail-test-modal-dismiss">
                            <?php echo esc_html__('Cerrar', 'navai-voice'); ?>
                        </button>
                    </div>
        ...
        <div class="navai-guardrails-list">
            ...
            <p class="navai-admin-description">
                <?php echo esc_html__('Las reglas se aplican por prioridad ascendente y se evaluan por scope (input/tool/output).', 'navai-voice'); ?>
            </p>
