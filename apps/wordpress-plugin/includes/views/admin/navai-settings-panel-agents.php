    ...
    <div class="navai-admin-card navai-agents-panel" data-navai-agents-panel>
        ...
        <div class="navai-agents-grid">
            <section class="navai-agents-editor">
                <div class="navai-agents-section-head">
                    <h3><?php echo esc_html__('Agente especialista', 'navai-voice'); ?></h3>
                    <p class="navai-admin-description"><?php echo esc_html__('Define nombre, instrucciones y allowlists de tools/rutas.', 'navai-voice'); ?></p>
                </div>
                ...
                <div class="navai-agents-form-grid">
                    ...
                    <label class="navai-agents-form-grid-span-full">
                        ...
                        <textarea class="large-text code navai-agent-form-instructions" rows="6" placeholder="<?php echo esc_attr__('Instrucciones para este especialista...', 'navai-voice'); ?>"></textarea>
                    </label>
                    <label class="navai-agents-form-grid-span-full">
                        <span><?php echo esc_html__('Tools permitidas (csv)', 'navai-voice'); ?></span>
                        <input type="text" class="regular-text navai-agent-form-tools" placeholder="<?php echo esc_attr__('navigate_to, navai_custom_checkout', 'navai-voice'); ?>" />
                    </label>
                    <label class="navai-agents-form-grid-span-full">
                        <span><?php echo esc_html__('Rutas permitidas (csv de route_key)', 'navai-voice'); ?></span>
                        <input type="text" class="regular-text navai-agent-form-routes" placeholder="<?php echo esc_attr__('public:home, private:orders', 'navai-voice'); ?>" />
                    </label>
                    <label class="navai-agents-form-grid-span-full">
                        <span><?php echo esc_html__('Contexto extra del agente (JSON opcional)', 'navai-voice'); ?></span>
                        <textarea class="large-text code navai-agent-form-context" rows="4" placeholder="<?php echo esc_attr__('{\"team\":\"support\"}', 'navai-voice'); ?>"></textarea>
                    </label>
                </div>
                ...
                <div class="navai-agents-actions">
                    ...
                    <button type="button" class="button button-secondary navai-agents-reload"><?php echo esc_html__('Recargar', 'navai-voice'); ?></button>
                </div>
            </section>
        ...
        <div class="navai-handoffs-grid">
            <section class="navai-handoffs-editor">
                <div class="navai-agents-section-head">
                    <h3><?php echo esc_html__('Regla de handoff', 'navai-voice'); ?></h3>
                    <p class="navai-admin-description"><?php echo esc_html__('Delega a otro agente segun intencion, tool, payload, roles o contexto.', 'navai-voice'); ?></p>
                </div>
                ...
                <div class="navai-handoffs-form-grid">
                    ...
                    <label class="navai-agents-form-grid-span-full">
                        ...
                        <textarea class="large-text code navai-handoff-form-context" rows="4" placeholder="<?php echo esc_attr__('{\"channel\":\"support\"}', 'navai-voice'); ?>"></textarea>
                    </label>
                </div>
                ...
                <div class="navai-agents-actions">
                    ...
                    <button type="button" class="button button-secondary navai-handoffs-reload"><?php echo esc_html__('Recargar reglas', 'navai-voice'); ?></button>
                </div>
            </section>
